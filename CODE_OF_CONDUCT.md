...
* Be constructive and specific in code review feedback
...
* Stay on topic
* Be patient with duplicate issues (politely link to existing ones)
* Avoid "+1" comments (use GitHub reactions instead)
* Provide context when reporting bugs
* Be respectful when disagreeing with feature requests
...
* Don't take rejection of code personally
